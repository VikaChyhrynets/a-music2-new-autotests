...
public class DataUrls {
    ...
    public static final String API_CONTACTS = PropertyHelper.getProperty("api.contacts");
    ...
    public static final String USER_WRONG_PASS_ANOTHER = PropertyHelper.getProperty("api.testWrongPass2");
